...
from pipelines.inverted_ve_pipeline import CrossFrameAttnProcessor, ACTIVATE_LAYER_CANDIDATE, SD15_ATTENTION_LAYER_CANDIDATES, SharedAttentionProcessor, SharedAttentionProcessor_v2
...
class StableDiffusionPipeline(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if callback_on_step_end is not None:
                    ...
                    negative_prompt_embeds = callback_outputs.pop("negative_ prompt_embeds", negative_prompt_embeds)
    ...
    def activate_layer(self,
        ...
        for activate_layer_index in activate_layer_indices:
            activate_layer += SD15_ATTENTION_LAYER_CANDIDATES[activate_layer_index[0]:activate_layer_index[1]]
