...
def create_image_grid(image_list, rows, cols, padding=10):
    if isinstance(image_list, torch.Tensor):
        image_list = [ToPILImage()(img) for img in image_list]
...
SD15_ATTENTION_LAYER_CANDIDATES = [
        ...
        'down_blocks.2.attentions.0.transformer_blocks.0.attn2.processor',
        'down_blocks.2.attentions.1.transformer_blocks.0.attn1.processor',
        'down_blocks.2.attentions.1.transformer_blocks.0.attn2.processor', # 12

        'mid_block.attentions.0.transformer_blocks.0.attn1.processor',
        'mid_block.attentions.0.transformer_blocks.0.attn2.processor', # 2
        ...
        'up_blocks.1.attentions.1.transformer_blocks.0.attn2.processor',
        'up_blocks.1.attentions.2.transformer_blocks.0.attn1.processor',
        'up_blocks.1.attentions.2.transformer_blocks.0.attn2.processor', # 6
        ...
        'up_blocks.2.attentions.2.transformer_blocks.0.attn2.processor', # 6
        ...
        'up_blocks.3.attentions.2.transformer_blocks.0.attn2.processor', # 6
        # 'mid_block.attentions.0.transformer_blocks.0.attn1.processor',
        # 'mid_block.attentions.0.transformer_blocks.0.attn2.processor',
]
